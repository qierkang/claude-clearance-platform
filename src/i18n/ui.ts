...
export const ui = {
  en: {
    'meta.title': 'Claude Clearance | Claude environment risk check',
    'meta.description':
    ...
    'hero.badge.builtWithFable': 'Built with Claude Fable 5',
    'hero.scoreOutOf': '/ 100',
    ...
    'signals.title': 'Local scan',
    'signals.sub': 'Six browser-visible locale fingerprints, weighted to a 0–100 risk score.',
    'matrix.title': 'Clearance matrix',
    'matrix.sub': 'The upgraded view separates local browser signals from network-exit checks inspired by Claude AI IP check tools.',
    'matrix.local.title': 'Local environment',
    'matrix.local.body': 'Timezone, language, fonts, Intl locale and UA style can be checked in the browser without uploading scan results.',
    'matrix.network.title': 'Network exit',
    'matrix.network.body': 'Exit IP, country, ASN, WebRTC and DNS leakage require server-side or third-party visibility and should be labelled as network checks.',
    'matrix.evidence.title': 'Evidence and fixes',
    'matrix.evidence.body': 'Every hit should explain source, confidence, contribution and the concrete setting or route to review.',
    ...
    'faq.a4':
      'No. The scan runs in your browser and the result is not uploaded. The public wall only keeps the nickname and message you choose to post.',

    'privacy.title': 'Privacy',
    'privacy.body':
      'Every check runs locally in your browser — your scan result never leaves your device. The public wall only shows nicknames and messages visitors choose to post.',
  ...
  zh: {
    'meta.title': 'Claude 通关局 ｜ Claude 环境风险检测',
    'meta.description':
      '一键检测浏览器时区、语言、中文字体与 locale 等信号,评估你是否会被 Claude Code 判定为中国用户并有封号风险。纯本地运行,零数据上传。',

    'nav.title': 'Claude 通关局',
    'credit': '检测你是不是 Claude 眼里的中国地区老狗',

    'hero.title': '你的 Claude 环境能通关吗',
    'hero.badge.local': '纯本地检测',
    'hero.badge.noUpload': '结果零上传',
    'hero.badge.openSource': '开源代码',
    'hero.badge.builtWithFable': '此网站使用 Claude Fable 5 开发',
    'hero.scoreOutOf': '/ 100',
    ...
    'signals.title': '本地检测',
    'signals.sub': '六项浏览器可见区域指纹,加权得出 0–100 风险分。',
    'matrix.title': '通关矩阵',
    'matrix.sub': '升级版把本地浏览器信号与 Claude AI IP 检测类工具的网络出口维度分开展示。',
    'matrix.local.title': '本地环境',
    'matrix.local.body': '时区、语言、字体、Intl Locale 与 UA 风格可在浏览器内检测,扫描结果不需要上传。',
    'matrix.network.title': '网络出口',
    'matrix.network.body': '出口 IP、国家、ASN、WebRTC 与 DNS 泄漏需要服务端或第三方可见性,必须标注为网络检测。',
    'matrix.evidence.title': '证据与修复',
    'matrix.evidence.body': '每个命中项都应解释来源、可信度、风险贡献,并给出可检查的系统设置或网络路由建议。',
    ...
    'faq.q4': '会上传我的数据吗?',
    'faq.a4':
      '不会。检测结果只在你的浏览器里计算,不会上传。留言墙只展示你主动发布的昵称和留言内容。',
